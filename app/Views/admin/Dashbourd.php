  ...
  <section class="home-section">
    <div class="content card_content" id="contents">
      <div class="dashboard-cards">
        <!-- Booked Card -->
        <a href="<?= site_url('Admin/Booked_rooms') ?>" style="text-decoration: none;">
          <div class="card">
        ...
        <!-- Event Hall Card -->
        <a href="<?= site_url('Admin/Event_message') ?>" style="text-decoration: none;">
          <div class="card">
            <div class="card-header">
              EVENT HALL MESSAGE
        ...
        <!-- Staffs Card -->
        <a href="<?= site_url('Admin/Contact_message') ?>" style="text-decoration: none;">
          <div class="card">
            <div class="card-header">
              CONTACT MESSAGE
        ...
        <!-- Clients Card -->
        <a href="<?= site_url('Admin/User_list') ?>" style="text-decoration: none;">
          <div class="card">
            <div class="card-header">
              REGISTERED USERS
        ...
        <!-- Users Card -->
        <a href="<?= site_url('Admin/unregistered_clients') ?>" style="text-decoration: none;">
          <div class="card">
            <div class="card-header">
              UNREGISTERED USERS
        ...
        <!-- Staffs Card -->
        <a href="<?= site_url('Admin/Staff_list') ?>" style="text-decoration: none;">
          <div class="card">
            <div class="card-header">
              STAFFS
              <?php if ($totalstafs > 0): ?>
                <span class="badge bg-danger mt-2"><?= $totalstafs ?></span>
              <?php endif; ?>
            </div>
            <div class="card-body">
              <h5 class="card-title">Staff Members &nbsp; &nbsp; &nbsp; &nbsp;<?= $totalstafs ?></h5>
              <img src="/src/grouping.png" style="width:55px; height:45px; margin-left:30%;" alt="">
            </div>
          </div>
        </a>
      </div>
