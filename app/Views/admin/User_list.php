...
<head>
  ...
  <title>Admin Dashboard - Registered User</title>
...
<body>
  ...
  <section class="home-section">
    ...
    <div class="main-content">
      <div class="table-responsive">
        <table class="table table-striped table-bordered caption-top" id="RegisteredUser_Table">
                  ...
                  <td>
                    <div class="d-flex">
                      ...
                      <a href="javascript:void(0);" class="btn btn-sm viewContact" data-bs-toggle="modal"
                        ...
                        data-name="<?= esc($users['first_name']) ?>" data-email="<?= esc($users['email']) ?>"
                        data-phone="<?= esc($users['phone']) ?>" data-nationality="<?= esc($users['nationality']) ?>"
                        data-country="<?= esc($users['country']) ?>" data-state="<?= esc($users['state']) ?>"
                        data-city="<?= esc($users['city']) ?>" data-streetaddress="<?= esc($users['street_address']) ?>"
  ...
  <script>
    $(document).ready(function () {
      $('#RegisteredUser_Table').DataTable();
    });
  </script>
</body>
