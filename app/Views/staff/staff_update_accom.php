            ...
            <div class="row justify-content-center">
                <div class="col-lg-9">
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            <form action="<?= site_url('staff/update/' . $accommodation['id']) ?>" method="post"
                                enctype="multipart/form-data" class="row">
                                <?= csrf_field(); ?>
                                <div class="mb-3">
                                    <label for="title" class="form-label fw-bold">Title</label>
                                    <input type="text" class="form-control" id="title" name="title"
                                        value="<?= esc($accommodation['title']) ?>" placeholder="Enter the title"
                                        required>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="number" class="form-control" id="floor_number" name="floor_number"
                                        value="<?= esc($accommodation['floor_number']) ?>"
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="number" class="form-control" id="Room_Number" name="Room_Number"
                                        value="<?= esc($accommodation['Room_Number']) ?>"
                                        placeholder="Enter floor number">
                                </div>
                                <!-- <div class="mb-3 col-md-6">
                    ...
                    <input type="number" class="form-control" id="room_quantity" name="room_quantity" value="<?= esc($accommodation['room_quantity']) ?>" placeholder="Enter room_quantity">
                                ...
                                <div class="col-md-6"
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="has_lounge_area"
                                            name="has_lounge_area" <?= $accommodation['has_lounge_area'] ? 'checked' : '' ?>>
                                        <label class="form-check-label fw-bold" for="has_lounge_area">Lounge
                                            Area</label>
                                    </div>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <?php if (!empty($accommodation['image'])): ?>
                                        ...
                                        foreach ($images as $index => $image): ?>
                                            <div class="existing-image" id="image-<?= $index ?>">
                                                <img src="<?= esc($image) ?>" alt="Accommodation Image"
                                ...
                                <div class="text-center">
                                    <a href="<?= site_url('staff/staff_viewaccom') ?>" class="btn btn-secondary"
