...
<head>
    ...
    <!-- Page Title -->
    <title>Staff Dashboard - Contact Messages</title>
...
<?php echo view('/Components/staff_sidibar.php'); ?>
  <section class="home-section">
                  ...
                  <td>
                    <div class="d-flex">
                      <a href="javascript:void(0);" class="btn btn-sm viewContact" data-id="<?= esc($contact['id']) ?>"
                        ...
                        title="View" onclick="markAsSeen2(<?= $contact['id']; ?>)">
                      ...
                      <!-- Delete Button -->
                      <a href="<?= site_url('/StaffController/delete_ContactMessage/' . $contact['id']) ?>"
                        class="btn btn-sm"
    ...
    <!-- Modal Structure -->
    <div class="modal fade" id="contactDetailsModal" tabindex="-1" aria-labelledby="contactDetailsLabel"
      aria-hidden="true">
