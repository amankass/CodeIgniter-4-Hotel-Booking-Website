        ...
        <div class="row justify-content-center">
          <div class="col-lg-11" style="margin-left: 2rem;">
            <div class="card shadow-sm">
              ...
              <div class="card-body">
                <form action="<?= site_url('/staff/Update_Booking/' . $booking['id']) ?>" method="post" class="row">
                  <?= csrf_field(); ?>
                  ...
                  <div class="form-group mb-3 col-md-6">
                    ...
                    <input type="date" class="form-control" id="date_of_birth" name="date_of_birth"
                      value="<?= isset($user['date_of_birth']) ? esc($user['date_of_birth']) : '' ?>" max="2007-12-31"
                      required>
                  ...
                  <div class="mb-3 col-md-6">
                    <label for="price" class="form-label fw-bold">Penality</label>
                    <select class="form-select" name="penality" id="" required>
                  ...
                  <div class="mb-3 col-md-6">
                    ...
                    <input type="number" class="form-control" id="addfee" name="addfee"
                      value="<?= esc($booking['additional_fee'] < 0 ? 0 : $booking['additional_fee']) ?>" readonly>
                  </div>

                  <div class="mb-3 col-md-6">
                    <label for="addfee" class="form-label fw-bold">Refund Fee</label>
                    <input type="number" class="form-control" id="refundfee" name="addfee"
                      value="<?= esc($booking['refund_fee'] < 0 ? abs($booking['refund_fee']) : 0) ?>" readonly>
                  </div>
