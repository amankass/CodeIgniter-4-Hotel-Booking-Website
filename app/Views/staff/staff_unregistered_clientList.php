...
<head>
    ...
    <title>Staff Dashboard - Unregistered User</title>
    <!-- Bootstrap CSS -->
                    ...
                    <tbody>
                        <?php if (!empty($Unregistered_User)): ?>
                            <?php foreach ($Unregistered_User as $index => $users): ?>
                                ...
                                <!--<td><?= esc($users['country']) ?></td> Price per night -->
                                <!--<td><?= esc($users['state']) ?></td>  Price per night -->
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <!-- Delete Button -->
                                        <a href="<?= site_url('/Staff/delete_UnregisteredUser/' . $users['id']) ?>"
                                            class="btn btn-sm"
